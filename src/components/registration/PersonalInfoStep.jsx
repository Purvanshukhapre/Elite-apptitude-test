  ...
  return (
    <div className="space-y-8">
        ...
        <div>
          ...
          <div className={`relative rounded-lg transition-all duration-200 ${errors.fullName ? 'ring-2 ring-red-500' : 'focus-within:ring-2 focus-within:ring-blue-500'}`}>
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-all duration-200"
            />
          </div>
          {errors.fullName && (
      ...
      <div>
        ...
        <div className={`relative rounded-lg transition-all duration-200 ${errors.permanentAddressLine ? 'ring-2 ring-red-500' : ''}`}>
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 focus:ring-offset-0 transition-all duration-200 resize-none"
          />
        </div>
